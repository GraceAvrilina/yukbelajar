...
@Component({
  selector: 'app-hasil-pts',
  templateUrl: './hasil-pts.component.html',
  styleUrls: ['./hasil-pts.component.scss'],
})
export class HasilPtsComponent implements OnInit {
datas
...
isOpen2 = false;
  constructor(
    ...
    async getData(){
      ...
      const response = await this.dataKelasService.infoUts(param)
